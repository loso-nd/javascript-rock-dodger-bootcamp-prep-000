...
GAME.appendChild(rock);
  ...
  function moveRock() {
    ...
    /** If a rock collides with the DODGER, we should call endGame() ,  Otherwise, if the rock hasn't reached the bottom of the GAME, we want to move it again.*/
...
function moveDodger(e) {
   ...
   * And be sure to use the functions declared below! */
   ...
   e.preventDefault();
   e.stopPropagation();
   e.which === 37 ? LEFT_ARROW :false:
   e.which === 39 ? RIGHT_ARROW: false;
 }*/
...
function moveDodgerLeft() {
  // implement me!  ** This function should move DODGER to the left (mabye 4 pixels?). Use window.requestAnimationFrame()!*/
